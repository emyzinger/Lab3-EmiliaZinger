...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    // TO DO also try with a LinkedList - does it make any difference?
  }
  ...
  public void testSizeNonEmpty() {
    // TO DO fix the expected values in the assertions below
    list.add(77);
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // TO DO using containsAll and Arrays.asList (see above)
  ...
  public void testAddAll() {
    // TO DO in a single statement using addAll and Arrays.asList,
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // TO DO in a single statement using removeAll and Arrays.asList,
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    // TO DO in a single statement using retainAll and Arrays.asList,
    // remove items from the list to make the following assertions pass
    // (without touching the assertions themselves)
  ...
  public void testSet() {
    ...
    list.add(77);
    list.add(66);
    // TO DO use the set method to change specific elements in the list
  ...
  public void testSubList() {
    ...
    list.add(77);
    list.add(66);
    // TO DO fix the arguments in the subList method so that the assertion
    // passes
